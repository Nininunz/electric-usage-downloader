...
why I reverse engineered the API instead of automating a download of the CSV as I had previously done. <br>~~Data can be imported into InfluxDB or VictoriaMetrics.~~
